...
def _reconstruct(labels, blank=0):# nếu như có 2 hoặc 3 hoặc 4 chữ trùng nhau sẽ loại bỏ đi các chữ trùng nhau 
    new_labels = []
    # merge same labels
    previous = None
    for l in labels:
...
def greedy_decode(emission_log_prob, blank=0, **kwargs): # gán xác xuất lên các từ , loại bỏ các từ trufngn hau 
...
def beam_search_decode(emission_log_prob, blank=0, **kwargs):
    ...
    # print(type(emission_threshold))
    # print(emission_log_prob.shape)
    # print(emission_threshold)
